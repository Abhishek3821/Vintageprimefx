...
interface AuthContext {
  user: { email?: string; name?: string; firstName?: string; lastName?: string; country?: string } | null;
  token: string | null;
  logout: () => void;
}
...
interface Position {
  instrument?: string;
  long?: { units?: string | number; averagePrice?: string | number; pl?: string | number; [key: string]: unknown };
  short?: { units?: string | number; averagePrice?: string | number; pl?: string | number; [key: string]: unknown };
  [key: string]: unknown;
}
