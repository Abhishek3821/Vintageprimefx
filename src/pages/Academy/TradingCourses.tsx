    ...
    <div className="bg-dark text-light py-5">
      <Container>
        ...
        <p className="mb-4">
          ...
          gain exclusive access to advanced courses on trading platforms, asset
          classes, online strategies, and more.
        </p>
        ...
        <Card className="bg-success text-white mt-5 border-0">
          <Card.Body>
            <h4 className="fw-bold">
              Start Your Learning Journey with AvaAcademy
            </h4>
            <p className="mb-3">
              Your path to becoming a confident, skilled trader begins here.
              Sign up now and access all courses for free.
            </p>
